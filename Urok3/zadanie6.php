...
<?php		
$menuArr = ["home", 
            "archive" => ["подпункт 1", "подпункт 2", "подпункт 3"], 
			"contact"];
...
<body>
	...
	<div id="content">
		...
		<div id="footer">
			<p> <?= getYear() ?> Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
